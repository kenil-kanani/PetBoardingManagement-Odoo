				...
				<div className="flex-1">
					...
					<div className="grid gap-4">
						<div>
							...
							<p>
								Buddy is a friendly and energetic Golden
								Retriever who loves to play fetch and go for
								long walks. He's great with kids and other pets,
								and he has a gentle, affectionate personality.
							</p>
						</div>
						<div>
							<h2 className="text-lg font-semibold">
