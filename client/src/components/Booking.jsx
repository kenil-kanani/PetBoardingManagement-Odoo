								...
								<ul className="grid w-full gap-6 md:grid-cols-3">
									{specialRequirements.map((req) => (
										<li key={req.id}>
											...
											<label
												htmlFor={`req-${req.id}`}
												className="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:bg-blue-300 hover:text-gray-600 peer-checked:text-black hover:bg-gray-50"
											>
												<div className="block">
